...
class Html {
    ...
    public static function print_r($data,$return=false) {
    ...
    public static function price($val,$options=false) {
    ...
    public static function getCurrencies($symbols=false) {
    ...
    public static function formatKey($key,$options=false) {
    ...
    public static function string($string,$options=false) {
    ...
    public static function stringLimit($string,$options=false) {
    ...
    public static function date($format,$date,$time=false,$options=false) {
